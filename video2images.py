'''
Reference: https://github.com/zxcver/spatio-time-mtmc/blob/main/transfer/video2images.py
'''
import cv2
import os
...
def main():
    ...
    for scence_id,cam_megs in scence_dict.items():
        ...
        for cam_id in cam_ids:
            ...
            video_file = os.path.join('mcmt/dataset',cam_path,scence_id,cam_id,'vdo.avi') 
