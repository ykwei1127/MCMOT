            ...
            for res_path in scene_path.glob("*/res.txt"):
                with open(res_path, "r") as tmp_f:
                    for line in tmp_f.readlines():
                        f.write(line)
        if os.path.exists(f"/home/ykwei/MCMT-SU/campus/eval/track_{scene_path.stem}.txt"):
            os.remove(f"/home/ykwei/MCMT-SU/campus/eval/track_{scene_path.stem}.txt")
        shutil.copyfile(results_filename, f"/home/ykwei/MCMT-SU/campus/eval/track_{scene_path.stem}.txt")
