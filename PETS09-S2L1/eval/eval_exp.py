...
def print_results(summary, mread=False):
    ...
    summary = summary[['idf1', 'idtp', 'idfp', 'idfn', 'mota', 'motp', 'mostly_tracked', 'mostly_lost', 'precision', 'recall', 'num_switches']]
    summary['idf1'] *= 100
    summary['mota'] *= 100
...
def eval(test, pred, **kwargs):
    ...
    def compare_dataframes_mtmc(gts, ts):
        ...
        metrics.extend(['idf1','idfp','idfn','idtp','mota','motp','mostly_tracked','mostly_lost','precision','recall','num_switches'])
